	...
	<div id="grid" class="main-content">
		...
		<c:forEach var="product" items="${products}">
			...
			<div class="tile  ${tileHolder}">
				...
				<!--  the image when clicked will go the the productDetail and pull the image based on the param above -->
				<a class="product-image" href="${productDetail}"><img src="${productImage}"></a>
