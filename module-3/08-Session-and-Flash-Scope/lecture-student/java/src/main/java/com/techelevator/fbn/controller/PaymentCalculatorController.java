...
public class PaymentCalculatorController {
	...
	public String showMortgagePaymentCalculatorResults(@RequestParam int loanAmount, @RequestParam int loanTerm,
			@RequestParam("rate") double interestRate, ModelMap model) {
